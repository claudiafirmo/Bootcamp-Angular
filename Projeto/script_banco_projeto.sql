...
create table if not exists tb_empresa(
	...
	CONSTRAINT fk_idendereco_tbempresa FOREIGN KEY (idendereco) REFERENCES tb_endereco (id),
...
create table if not exists tb_candidato(
	...
	CONSTRAINT fk_idendereco_tbcandidato FOREIGN KEY (idendereco) REFERENCES tb_endereco (id),
...
CREATE TABLE IF NOT EXISTS tb_beneficiovagas (
	...
	CONSTRAINT fk_idvaga_tbvagas FOREIGN KEY (idvaga) REFERENCES tb_vaga(id),
...
CREATE TABLE IF NOT EXISTS tb_inscricao_candidato (
	...
	CONSTRAINT fk_idvaga_tbvagas FOREIGN KEY (idvaga) REFERENCES tb_vaga(id),
	CONSTRAINT fk_idcandidato FOREIGN KEY (idcandidato) REFERENCES tb_candidato(id)
);

CREATE TABLE IF NOT EXISTS tb_ofertavagas (
	id serial,
	idvaga 		int,
	quantidade_vaga CHAR(3)	NOT NULL,
	CONSTRAINT pk_ofertavagas PRIMARY KEY(id),
	CONSTRAINT fk_idvaga_ofertavagas FOREIGN KEY (idvaga) REFERENCES tb_vaga(id)
);
