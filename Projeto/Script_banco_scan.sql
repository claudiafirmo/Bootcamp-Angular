...
--Insert Vaga
insert into tb_vaga values (1,1,4,3,5,'ANALISTA DE SISTEMAS JUNIOR','Por conseguinte, a necessidade de renovação processual causa impacto indireto na reavaliação do orçamento setorial. O empenho em analisar o fenômeno da Internet é uma das consequências do fluxo de informações. Assim mesmo, o comprometimento entre as equipes prepara-nos para enfrentar situações atípicas decorrentes do sistema de participação geral.',1000.32,'2023-01-01T00:00:00Z');
insert into tb_vaga values (2,2,2,3,7,'COORDENADOR DE VENDAS','A certificação de metodologias que nos auxiliam a lidar com a determinação clara de objetivos cumpre um papel essencial na formulação do processo de comunicação como um todo. Acima de tudo, é fundamental ressaltar que o comprometimento entre as equipes deve passar por modificações independentemente dos métodos utilizados na avaliação de resultados. A prática cotidiana prova que o consenso sobre a necessidade de qualificação acarreta um processo de reformulação e modernização dos níveis de motivação departamental. Por outro lado, o aumento do diálogo entre os diferentes setores produtivos nos obriga à análise das direções preferenciais no sentido do progresso. É importante questionar o quanto o novo modelo estrutural aqui preconizado estimula a padronização de alternativas às soluções ortodoxas.',9541.25,'2022-12-25T00:00:00Z');
insert into tb_vaga values (3,3,1,1,6,'ANALISTA DE SISTEMAS SENIOR','Por conseguinte, a necessidade de renovação processual causa impacto indireto na reavaliação do orçamento setorial. O empenho em analisar o fenômeno da Internet é uma das consequências do fluxo de informações. Assim mesmo, o comprometimento entre as equipes prepara-nos para enfrentar situações atípicas decorrentes do sistema de participação geral.',4500.25,'2022-12-31T00:00:00Z');
insert into tb_vaga values (4,3,1,1,6,'GERENTE DE PROJETO','Por conseguinte, a necessidade de renovação processual causa impacto indireto na reavaliação do orçamento setorial. O empenho em analisar o fenômeno da Internet é uma das consequências do fluxo de informações. Assim mesmo, o comprometimento entre as equipes prepara-nos para enfrentar situações atípicas decorrentes do sistema de participação geral.',3000.27,'2022-12-31T00:00:00Z');
insert into tb_vaga values (5,4,3,2,4,'MENOR APRENDIZ',' Desta maneira, o consenso sobre a necessidade de qualificação oferece uma interessante oportunidade para verificação dos índices pretendidos. O empenho em analisar o surgimento do comércio virtual auxilia a preparação e a composição do sistema de participação geral. Todavia, a complexidade dos estudos efetuados pode nos levar a considerar a reestruturação das diversas correntes de pensamento. Caros amigos, o julgamento imparcial das eventualidades estimula a padronização dos procedimentos normalmente adotados. Nunca é demais lembrar o peso e o significado destes problemas, uma vez que a crescente influência da mídia maximiza as possibilidades por conta das condições financeiras e administrativas exigidas.',950.00,'2023-02-28T00:00:00Z');
...
--Insert Oferta Vaga
insert into tb_ofertavagas values (1,1,'999');
insert into tb_ofertavagas values (2,2,'10');
insert into tb_ofertavagas values (3,3,'3');
insert into tb_ofertavagas values (4,4,'15');
insert into tb_ofertavagas values (5,5,'110');
